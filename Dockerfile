...
RUN add-apt-repository universe && add-apt-repository multiverse && apt-get update && apt-get upgrade -y && apt-get -y install make git-core libssl-dev pkg-config libclang-18-dev build-essential protobuf-compiler
